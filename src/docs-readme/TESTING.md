...
| Bookmark Post                 | If logged in, click the bookmark button            | The bookmark status should toggle, and the saved post should be displayed under the bookmarks page                                                                              | PASS    |
| Remove Bookmarks              | If logged in, click the bookmark button            | The bookmark status should toggle, and the removed bookmark post should be deleted from the bookmark page                                                                       | PASS    |
